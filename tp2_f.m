...
function tp2_f( TCPD, TCPV, TMPD, TMPV, TFE, Rep )
...
for i = 1:Rep,
  [ TPDDados(i), TPDVoIP(i), AMPDados(i), AMPVoIP(i), AMaxPDados(i), AMaxPVoIP(i), OMF(i) ] = simLD_f( TCPD, TCPV, TMPD, TMPV, CL, TFE, NP );
end
